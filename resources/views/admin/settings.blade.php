            ...
            <form action="{{ route('admin.update_settings') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col space-y-2 px-4">
                    ...
                    <input type="file" name="logo" id="logo" value=""
                        class="border-2 border-accent/20  bg-primary rounded " placeholder="Logo" />
                </div>
                <div class="flex flex-col space-y-2 px-4">
                ...
                <div class="flex flex-col space-y-2 px-4">
                    ...
                    <input type="text" name="contact_address" id="contact_address"
                        value="{{ $settings->contact_address }}" class="border-2 border-accent/20  bg-primary rounded "
                ...
                <div class="flex flex-col space-y-2 px-4">
                    ...
                    <input type="file" name="menu_path" id="menu_path"
                        class="border-2 border-accent/20  bg-primary rounded " placeholder="Menu pdf" />
