    ...
    <div id={{ $id }}
        ...
        <div class="rounded shadow p-4 w-full h-full flex flex-col overflow-auto ">
            ...
            <div
                ...
                <form action="{{ route('admin.edit_professional') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="flex justify-center items-center py-4">
                        <h2 class="text-2xl font-bold">Edit Professional</h2>
                    </div>
                    ...
                    <div class="flex flex-col space-y-2 px-4 py-2">
                        ...
                        <textarea name="description" id="description" cols="10" rows="10"
                            class="edit-input border-2 border-accent/20  bg-primary rounded"></textarea>
                    </div>
