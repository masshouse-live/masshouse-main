    ...
    <div id={{ $id }}
        ...
        <div class="rounded shadow p-4 w-full h-full flex flex-col overflow-auto ">
            ...
            <div
                ...
                <form action="{{ route('admin.edit_event_venue') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col space-y-2 px-4">
                        ...
                        <input type="text" name="address" id="address" value=""
                            class="edit-input border-2 border-accent/20  bg-primary rounded " placeholder="Address" />
                    </div>
                    <div class="flex flex-col space-y-2 px-4">
                        <label class="font-bold" for="cover_photo">
                            Cover Image
                        </label>
                        <input type="file" name="cover_photo" id="cover_photo" value=""
                            class="edit-input bg-primary rounded " placeholder="Address" />
                        <small id="file_cover_photo" class="text-accent"></small>
